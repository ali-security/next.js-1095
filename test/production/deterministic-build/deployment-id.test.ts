...
const IGNORE_CONTENT = new RegExp(
  [
    // These contain content-hashed browser or edge chunk names, or the deployment id query param
    '.html',
    '.rsc',
    'build-manifest.json',
    ...
    // required-server-files.json contains the nextConfig and therefore deploymentId
